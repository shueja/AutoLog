 ...
 * [X, Y, Yaw]
 */
public class Pose3dEntry implements DoubleArrayPublisher  {
    public static final String kDataType = "Pose3d";
    private final DoubleArrayPublisher m_entry;
    public Pose3dEntry(NetworkTableInstance table, String name) {
     ...
     */
    public void set(Pose3d value, long timestamp) {
